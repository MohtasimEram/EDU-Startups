  ...
  return (
    <header className="w-full bg-[#F5F5DC] py-4 shadow-md">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-4">
        ...
        {/* Search + User Section */}
        {isLoggedIn ? (
          <div className="flex flex-col md:flex-row md:items-center w-full md:w-auto relative space-y-2 md:space-y-0 md:space-x-4">
            ...
            <div className="relative w-full md:w-96">
              <input
                ...
                className="w-full pl-12 pr-4 py-2 rounded-lg bg-white text-black text-sm md:text-base font-poppins font-bold focus:outline-none focus:ring-2 focus:ring-[#3D0301]"
              />
            ...
            <div className="relative">
              <button
                ...
                className="bg-[#3D0301] text-white font-bold font-poppins px-4 py-2 rounded-lg hover:bg-[#6B1532] text-sm md:text-base"
              >
                {username || 'User'}
              </button>
              {isDropdownOpen && (
          ...
          <div className="flex space-x-4">
            <Link to="/login">
              <button className="text-[#000000] font-bold font-poppins text-sm md:text-lg hover:text-[#6B1532]">Login</button>
            </Link>
            <Link to="/signup">
