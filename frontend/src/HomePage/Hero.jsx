...
function Hero() {
  return (
    <section className="w-full bg-[#B03052] min-h-screen flex flex-col md:flex-row items-center justify-center px-4 py-12">
      
      {/* Text Content */}
      <div className="flex-1 flex flex-col justify-center mb-8 md:mb-0">
        <h1 className="text-4xl md:text-7xl font-bold font-poppins text-white mb-6 leading-tight">EDU Startups</h1>
